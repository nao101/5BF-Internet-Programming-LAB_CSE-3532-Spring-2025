            ...
            {serviceData.map((service) => (
                <div data-aos="fade-up"
                    ...
                    <div
                        ...
                        <div className="md:w-[50%]">
                            <h2 className="lg:text-3xl md:text-2xl text-xl text-red-600 font-bold mt-6 md:mt-0">{service.name}</h2>
                            <p className="md:text-xl text-base mb-2  mt-2 text-justify">
                                {service.description.slice(0, 200)}...
                            </p>
                            <p className="text-xl font-semibold text-red-500">Price: Free of Cost{service.price}</p>
